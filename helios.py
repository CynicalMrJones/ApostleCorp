...
#
# input = ptg.InputField(prompt="Command: ", multiline=False).bind(ptg.keys.ENTER, lambda input,: test() )
#
# def test():
...
# showcase = ptg.Window(
#     ptg.Splitter(
#         ptg.Container(ptg.Label("Welcome to [bold]HELIOS[/]\n")),
#     ),
#     ptg.Splitter(
#         ptg.Container(ptg.Label("Controlling bots since 1997")),
#     ),
#     ptg.Container(
#         input,
#     ),
